        ...
        <section id="form-container">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <x-text-input id="username" type="text" placeholder="Username" name="username" :value="old('username')"
                ...
                <div>
                    ...
                    <button id="password-visibility-toggle" class="visibility-toggle"><svg width="24" height="16"
